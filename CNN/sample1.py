...
#    for filepath in os.listdir("C:\\Users\\jinzai16\\Documents\\tei\\keras\\data\\ex1_data\\img0"):
    for filepath in os.listdir("C:\\Users\\yunsock\\OneDrive\\ドキュメント\\PET\\2020\\CNN\\data\\img0"):
        print("data\\img0\\" + filepath)
        img = img_to_array(load_img("data\\img0\\" + filepath, target_size=(img_width,img_height, img_ch)))
        data_x.append(img)
...
#    for filepath in list_imgs(SAVE_DATA_DIR_PATH + "img1"):
    for filepath in os.listdir("C:\\Users\\yunsock\\OneDrive\\ドキュメント\\PET\\2020\\CNN\\data\\img1"):
        print("data\\img1\\" + filepath)
        img = img_to_array(load_img("data\\img1\\" + filepath, target_size=(img_width,img_height, img_ch)))
        data_x.append(img)
...
#    for filepath in list_imgs(SAVE_DATA_DIR_PATH + "img2"):
    for filepath in os.listdir("C:\\Users\\yunsock\\OneDrive\\ドキュメント\\PET\\2020\\CNN\\data\\img2"):
        print("data\\img2\\" + filepath)
        img = img_to_array(load_img("data\\img2\\" + filepath, target_size=(img_width,img_height, img_ch)))
        data_x.append(img)
